    ...
    function i(e, t) {
        return (
            ...
            (function(e, t) {
                ...
                try {
                    for (
                        var u, a = e[Symbol.iterator](); !(i = (u = a.next()).done) &&
                        (n.push(u.value), !t || n.length !== t); i = !0
                    );
                } catch (e) {
                    (r = !0), (o = e);
                } finally {
    ...
    if (
        (Array.prototype.find ||
            (Array.prototype.find = function(e) {
                ...
                for (
                    var t, n = Object(this), i = n.length >>> 0, r = arguments[1], o = 0; o < i; o++
                )
        ...
        void 0 !== window.Event && (o.prototype = window.Event.prototype),
                    ...
                    t, [{
                        ...
                        },
                        {
                            ...
                            value: function(e, t, n) {
                                var i = e.tribute,
                                    r = i.range.getTriggerInfo(!1,
                                        i.hasTrailingSpace, !0,
                                        i.allowSpaces,
                                        i.autocompleteMode
                                    );
                        ...
                        },
                        {
                            ...
                            value: function(e) {
                                ...
                                var t = this.tribute.range.getTriggerInfo(!1,
                                    this.tribute.hasTrailingSpace, !0,
                ...
                n(t, [{
                        ...
                        value: function(e) {
                            ...
                            (this.menuContainerScrollEvent = this.debounce(
                                function() {
                                    t.tribute.isActive && t.tribute.hideMenu();
                                },
                                10, !1
                            )),
                            ...
                            this.tribute.range
                                ...
                                this.menuContainer.addEventListener(
                                    "scroll",
                                    this.menuContainerScrollEvent, !1
                                ) :
            ...
            return (
                n(t, [{
                    ...
                    },
                    {
                        ...
                        value: function(e) {
                            var t,
                                n = this.tribute.current,
                                i = this.getTriggerInfo(!1,
                                    this.tribute.hasTrailingSpace, !0,
                                    this.tribute.allowSpaces,
                                    this.tribute.autocompleteMode
                                );
                            if (void 0 !== i) {
                                if (!this.tribute.positionMenu)
                                    return void(this.tribute.menu.style.cssText =
                                        "display: block;");
                                (t = this.isContentEditable(n.element) ?
                                    this.getContentEditableCaretPosition(i.mentionPosition) :
                        ...
                        value: function(e, t, n, i, r) {
                            ...
                            if (void 0 !== o) {
                                var u = this.tribute.current,
                                    a = new CustomEvent("tribute-replaced", {
                                        detail: {
                                            item: r,
                                            instance: u,
                                            context: o,
                                ...
                                if (this.isContentEditable(u.element)) {
                                    ...
                                    this.tribute.autocompleteMode ||
                                        (l += o.mentionTriggerChar.length),
                                        this.pasteHtml(e, o.mentionPosition, l);
                                } else {
                                    ...
                                    this.tribute.autocompleteMode ||
                                        ...
                                        (s.value =
                                            s.value.substring(0, h) +
                                            e +
                                            s.value.substring(d, s.value.length)),
                                        (s.selectionStart = h + e.length),
                                        (s.selectionEnd = h + e.length);
                                }
                    ...
                    },
                    {
                        ...
                        value: function(e, t, n) {
                            ...
                            o.innerHTML = e;
                            for (
                                var u, a, l = this.getDocument().createDocumentFragment();
                                (u = o.firstChild);
                    ...
                    },
                    {
                        ...
                        value: function(e) {
                            ...
                            return (
                                (e = e.replace(/\u00A0/g, " ")),
                                (t = this.tribute.autocompleteSeparator ?
                                    e.split(this.tribute.autocompleteSeparator) :
                                    e.split(/\s+/))[t.length - 1].trim()
                            );
                        },
                    },
                    {
                        ...
                        value: function(e, t, n, i, r) {
                            var o,
                                ...
                                a,
                                l = this,
                                s = this.tribute.current;
                            if (this.isContentEditable(s.element)) {
                                var c = this.getContentEditableSelectedPath(s);
                                c && ((o = c.selected), (u = c.path), (a = c.offset));
                                ...
                                if (
                                    (this.tribute.collection.forEach(function(e) {
                                            var t = e.trigger,
                                                ...
                                                l.lastIndexWithLeadingSpace(h, t) :
                                                h.lastIndexOf(t);
                                    ...
                                    var b = i ? /[^\S ]/g : /[\xA0\s]/g;
                                    if (
                                        ((this.tribute.hasTrailingSpace = b.test(p)), !g && (e || !b.test(p)))
                                    )
                                        return {
                                            mentionPosition: m,
                                            mentionText: p,
                    ...
                    },
                    {
                        ...
                        value: function(e, t) {
                            var n = window.innerWidth,
                                ...
                                s = "number" == typeof e.bottom ? e.bottom : e.top + t.height,
                                c =
                    ...
                    },
                    {
                        ...
                        value: function(e, t, n) {
                            ...
                            this.getDocument().body.appendChild(i);
                            var r = i.style,
                            ...
                            (u.textContent = e.value.substring(0, t)),
                            i.appendChild(u),
                                "INPUT" === e.nodeName &&
                            ...
                            (l.textContent = e.value.substring(t)), i.appendChild(l);
                            ...
                            return (
                                this.getDocument().body.removeChild(i),
                                this.getFixedCoordinatesRelativeToRect(c)
                            );
                        },
                    },
                    {
                    ...
                    },
                    {
                        ...
                        value: function(e) {
                            var t = {
                                ...
                                n = this.getMenuDimensions(),
                                i = e.top,
                                r = window.innerHeight - (e.top + e.height);
                            r < n.height &&
                                (i >= n.height || i > r ?
                                    ((t.top = "auto"),
                                        (t.bottom = window.innerHeight - e.top),
                                        r < n.height && (t.maxHeight = i)) :
                                    i < n.height && (t.maxHeight = r));
                            var o = e.left,
                                u = window.innerWidth - e.left;
                            return (
                                u < n.width &&
                                (o >= n.width || o > u ?
                                    ((t.left = "auto"),
                                        (t.right = window.innerWidth - e.left),
                                        u < n.width && (t.maxWidth = o)) :
                                    o < n.width && (t.maxWidth = u)),
                                t
                            );
                        },
                    },
                    ...
                    },
                    {
                        ...
                        value: function(e, t, n, i, r) {
                            ...
                            if (!(e.length === n || t.length - i > e.length - n)) {
                                for (var o, u, a = t[i], l = e.indexOf(a, n); l > -1;) {
                                    if (
                                        (r.push(l),
                                            (u = this.traverse(e, t, l + 1, i + 1, r)),
                                            r.pop(), !u)
                                    )
                                        return o;
    ...
    return (function() {
        function t(n) {
            var i,
                ...
                g = n.containerClass,
                b = void 0 === g ? "tribute-container" : g,
                y = n.itemClass,
                w = void 0 === y ? "" : y,
                T = n.trigger,
                S = void 0 === T ? "@" : T,
                C = n.autocompleteMode,
                k = void 0 !== C && C,
                E = n.autocompleteSeparator,
                x = void 0 === E ? null : E,
                A = n.selectTemplate,
                M = void 0 === A ? null : A,
                L = n.menuItemTemplate,
                I = void 0 === L ? null : L,
                N = n.lookup,
                P = void 0 === N ? "key" : N,
                R = n.fillAttr,
                ...
                _ = n.noMatchTemplate,
                B = void 0 === _ ? null : _,
                j = n.requireLeadingSpace,
                K = void 0 === j || j,
                q = n.allowSpaces,
                U = void 0 !== q && q,
                z = n.replaceTextSuffix,
                Y = void 0 === z ? null : z,
                Q = n.positionMenu,
                X = void 0 === Q || Q,
                V = n.spaceSelectsMatch,
                $ = void 0 !== V && V,
                G = n.searchOpts,
                J = void 0 === G ? {} : G,
                Z = n.menuItemLimit,
                ee = void 0 === Z ? null : Z,
                te = n.menuShowMinLength,
                ne = void 0 === te ? 0 : te;
            if (
                (e(this, t),
                    (this.autocompleteMode = k),
                    (this.autocompleteSeparator = x),
                    (this.menuSelected = 0),
                    (this.current = {}),
                    (this.inputEvent = !1),
                    (this.isActive = !1),
                    (this.menuContainer = F),
                    (this.allowSpaces = U),
                    (this.replaceTextSuffix = Y),
                    (this.positionMenu = X),
                    (this.hasTrailingSpace = !1),
                    (this.spaceSelectsMatch = $),
                    this.autocompleteMode && ((S = ""), (U = !1)),
                    c)
            )
                this.collection = [{
                    trigger: S,
                    ...
                    containerClass: b,
                    itemClass: w,
                    selectTemplate: (M || t.defaultSelectTemplate).bind(this),
                    menuItemTemplate: (I || t.defaultMenuItemTemplate).bind(this),
                    noMatchTemplate:
                        ((i = B),
                            "string" == typeof i ?
                            "" === i.trim() ?
                    ...
                    fillAttr: D,
                    values: c,
                    loadingItemTemplate: d,
                    requireLeadingSpace: K,
                    searchOpts: J,
                    menuItemLimit: ee,
                    menuShowMinLength: ne,
                }, ];
            else {
                if (!W) throw new Error("[Tribute] No collection specified.");
                this.autocompleteMode &&
                    console.warn(
                        "Tribute in autocomplete mode does not work for collections"
                    ),
                    (this.collection = W.map(function(e) {
                        return {
                            trigger: e.trigger || S,
                            iframe: e.iframe || m,
                            selectClass: e.selectClass || v,
                            containerClass: e.containerClass || b,
                            itemClass: e.itemClass || w,
                            selectTemplate: (
                                ...
                                "function" == typeof this.current.collection.values ?
                                    (this.current.collection.loadingItemTemplate &&
                                        ((this.menu.querySelector("ul").innerHTML =
                                                this.current.collection.loadingItemTemplate),
                                            this.range.positionMenuAtCaret(t)),
