!(function(n, r) {
    ...
    function j(n, r) {
        return (
            ...
            function() {
                for (
                    var t = Math.max(arguments.length - r, 0), e = Array(t), u = 0; u < t; u++
                )
                    e[u] = arguments[u + r];
                switch (r) {
                    case 0:
    ...
    function jr(n, r, t) {
        r = Pn(r, t);
        for (
            var e = !tr(n) && nn(n), u = (e || n).length, o = Array(u), i = 0; i < u; i++
        ) {
            var a = e ? e[i] : i;
            o[i] = r(n[a], a, n);
        }
    ...
    var Zr = Yr({
        ...
        range: function(n, r, t) {
            ...
            for (
                var e = Math.max(Math.ceil((r - n) / t), 0), u = Array(e), o = 0; o < e; o++, n += t
            )
                u[o] = n;
            return u;
        },
