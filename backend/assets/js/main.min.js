...
function mainWrapperHeightFix() {
    ...
    setup_menu.css("min-height", $(document).outerHeight(!0) - 114 + "px"), $("#menu").css("min-height", $(document).outerHeight(!0) + "px"), content_wrapper.css("min-height", $(document).outerHeight(!0) - 57 + "px"), content_wrapper.css("height", "100%"), t < e && content_wrapper.css("min-height", e + "px"), t < e && e < $(window).height() && content_wrapper.css("min-height", $(window).height() - 57 + "px"), t > e && t < $(window).height() && content_wrapper.css("min-height", $(window).height() - 57 + "px"), is_mobile() && "true" == isRTL && side_bar.css("min-height", $(document).outerHeight(!0) - 57 + "px")
}
...
function elFinderBrowser(e, t, a) {
    return tinymce.activeEditor.windowManager.elfinderCallback = e, tinymce.activeEditor.windowManager.openUrl({
...
function init_editor(e, t) {
    ...
    if (0 !== a.length) {
        ...
        if ("true" == isRTL && (i.directionality = "rtl", i.plugins.push("directionality")), void 0 !== t)
...
function edit_note(e) {
    ...
    "" !== t && ($.post(admin_url + "misc/edit_note/" + e, {
        ...
        !0 !== (t = JSON.parse(t)).success && "true" != t.success || (alert_float("success", t.message), $("body").find('[data-note-description="' + e + '"]').html(t.description))
    })), toggle_edit_note(e))
}
...
function lead_profile_form_handler(e) {
    ...
    return $(".lead-save-btn").addClass("disabled").attr("disabled", !0), $.post(e.attr("action"), t).done((function(e) {
...
function print_lead_information() {
    ...
    e.find("p").css("font-size", "100%").css("font", "inherit").css("vertical-align", "baseline").css("margin", "0px"), e.find("h4").css("font-size", "100%"), e.find("dt").each((function() {
...
function recalculate_checklist_items_progress() {
    var e = $('input[name="checklist-box"]:checked').length,
        ...
        a = 0,
        i = $(".task-progress-bar");
    if ($(".task-total-checklist-completed").text(e), 0 == t ? $("#task-no-checklist-items").removeClass("hide") : $("#task-no-checklist-items").addClass("hide"), !(t >= 2)) return i.parents(".progress").addClass("hide"), e > 0 ? $(".chk-toggle-buttons").removeClass("hide") : $(".chk-toggle-buttons").addClass("hide"), !1;
...
function _init_timers_top_html(e) {
    ...
    e.total_timers > 0 ? t.removeClass("hide").html(e.total_timers) : t.addClass("hide"), e.total_timers > 0 ? $("#top-timers").find("i").addClass("tw-animate-spin-slow") : $("#top-timers").find("i").removeClass("tw-animate-spin-slow"), $("#started-timers-top").html(e.html)
}
...
function clear_item_preview_values(e) {
    var t = $("table.items tbody").find("tr:last-child").find("select").selectpicker("val"),
        a = $(".main");
    a.find("textarea").val(""), a.find('td.custom_field input[type="checkbox"]').prop("checked", !1), a.find("td.custom_field input:not(:checkbox):not(:hidden)").val(""), a.find("td.custom_field select").selectpicker("val", ""), a.find('input[name="quantity"]').val(1), a.find("select.tax").selectpicker("val", t), a.find('input[name="rate"]').val(""), a.find('input[name="unit"]').val(""), a.find("#main-optional").prop("checked", !1), a.find("#main-optional").trigger("change"), a.find("#main-optional-choosen").prop("checked", !0), $('input[name="task_id"]').val(""), $('input[name="expense_id"]').val("")
}
        ...
        return get_taxes_dropdown_template(l, e.taxname).done((function(a) {
            ...
            l.length > 0 && $.each(l, (function() {
                ...
                if (a.is(":checkbox")) {
                    ...
                    c.attr("name", i);
                    var _ = c.clone();
                    _.prop("required", 1), p.append(_), $.each(d, (function(e, t) {
...
function get_item_preview_values() {
    var e = {};
    return e.description = $('.main textarea[name="description"]').val(), e.long_description = $('.main textarea[name="long_description"]').val(), e.qty = $('.main input[name="quantity"]').val(), e.taxname = $(".main select.tax").selectpicker("val"), e.rate = $('.main input[name="rate"]').val(), e.unit = $('.main input[name="unit"]').val(), e.is_optional = $("#main-optional").prop("checked") ? 1 : 0, e.is_selected = $("#main-optional-choosen").prop("checked") ? 1 : 0, e
}
...
function calculate_total() {
    ...
    $(".tax-area").remove(), $.each(p, (function() {
        ...
        if (n = accounting.toFixed($(this).find("td.rate input").val() * r, app.options.decimal_places), n = parseFloat(n), $(this).find("td.amount").html(format_money(n, !0)), d && !c) return !0;
        l += n, i = $(this), (a = $(this).find("select.tax").selectpicker("val")) && $.each(a, (function(a, l) {
...
function init_invoices_total(e) {
    ...
    if (0 !== t.length) {
        ...
        if (!$("body").hasClass("invoices-total-manual") || void 0 !== e || i.hasClass("initialized"))
            if (a.length > 0 && i.hasClass("initialized")) a.removeClass("invoices-total-inline");
            else {
                ...
                void 0 !== l ? o.project_id = l : void 0 !== d && (o.customer_id = d), $.post(admin_url + "invoices/get_invoices_total", o).done((function(e) {
                    t.html(e)
                }))
            }
    }
...
function init_new_task_comment(e) {
    tinymce.get("task_comment") && tinymce.remove("#task_comment"), "undefined" != typeof taskCommentAttachmentDropzone && taskCommentAttachmentDropzone.destroy(), $("#dropzoneTaskComment").removeClass("hide"), $("#addTaskCommentBtn").removeClass("hide"), taskCommentAttachmentDropzone = new Dropzone("#task-comment-form", appCreateDropzoneOptions({
        uploadMultiple: !0,
    ...
    t.content_style = "span.mention {        background-color: #eeeeee;        padding: 3px;    }", t.setup = function(e) {
...
$("body").on("loaded.bs.select change", "select.ajax-search", (function(e) {
    ...
    $("body").on("change", 'select[name="tax"]', (function() {
        ...
        e.target.checked ? $(e.target).parent().next().css("display", "block") : $(e.target).parent().next().css("display", "none"), calculate_total()
