...
function confirm_delete() {
    ...
    t.fn.appFormValidator = function(n) {
        var i = this,
            ...
            r = t.extend({}, a, n);
        return void 0 === r.messages.email && (r.messages.email = o.email), i.configureJqueryValidationDefaults = function() {
            if (e) return !0;
            e = !0, t.validator.setDefaults({
            ...
            }), i.addMethodFileSize(), i.addMethodExtension()
        ...
        }, i.configureJqueryValidationDefaults(), i.each((function() {
            var e = t(this);
        ...
        error_highlight: function(t) {
            ...
            e.length && !e.is(":visible") && $('a[href="#' + e.attr("id") + '"]').css("border-bottom", "1px solid red").css("color", "red").addClass($.fn.appFormValidator.internal_options.validated_tab_class), $(t).is("select") ? delay((function() {
        ...
        if (jQuery.extend(n, e), t.constructor === String && (t = [t]), t = jQuery.grep(t, (function(t, e) {
                return "" != t
        ...
        t.fn.googleDrivePicker = function(e) {
            ...
            function o(e) {
                t(e).attr("data-picker-inited") || gapi.load("picker", (function() {
                    t(e).attr("data-picker-inited", !0), e.disabled = !1, e.addEventListener("click", (function() {
                        var e;
                        i || (i = google.accounts.oauth2.initTokenClient({
                            ...
                            r.mimeTypes && (e.setMimeTypes(r.mimeTypes), i.setMimeTypes(r.mimeTypes)), (new google.picker.PickerBuilder).addView(e).addView(i).setOAuthToken(n).setDeveloperKey(r.developerKey).setCallback(a).build().setVisible(!0), setTimeout((function() {
    ...
    function() {
        ...
        e.prototype.add = function(t) {
            ...
            var t, e = this.element == this.element.window,
                ...
                i = {};
            for (var a in this.handleScroll(), t = {
                    horizontal: {
                ...
                for (var s in this.waypoints[a]) {
                    var l, d, p, c, u = this.waypoints[a][s],
                        f = u.options.offset,
                        h = u.triggerPoint,
                        m = 0,
                        g = null == h;
    ...
    function(t) {
        ...
        jQuery, e = "smartresize", jQuery.fn[e] = function(t) {
            return t ? this.on("resize", (n = t, function() {
                var t = this,
                    e = arguments;
                a ? clearTimeout(a) : o && n.apply(t, e), a = setTimeout((function() {
            ...
            return this.each((function() {
                var e, n = t(this),
                    i = {
                        ...
                        adjustScroll: function() {
                            var o;
                            r = 0, n.find(".nav-tabs-horizontal li:not(.nav-tabs-submenu-child, nav-tabs-submenu-parent)").each((function(i, a) {
                                r += t(a).outerWidth(), t(a).hasClass("active") && r > n.width() && (o = t(a)), t(a).is(":last-child") && (e = t(a))
                            })), widthAvailale = n.width(), r > widthAvailale ? (n.find(".scroller").show(), i.updateArrowStyle(s), a = n.find(".nav-tabs-horizontal").outerWidth()) : n.find(".scroller").hide(), o && setTimeout((function() {
                                s = o.position().left - i.getArrowsTotalWidth(), n.find(".nav-tabs-horizontal").animate({
                                    scrollLeft: s
                                }, 100)
                            }), 150)
                        },
                        ...
                        updateArrowStyle: function(t) {
                            ...
                            }), t <= 0 ? (n.find(".arrow-left").addClass("disabled"), setTimeout((function() {
                ...
                return t(window).smartresize((function() {
                    ...
                    }).attr("data-sub-menu-id", o), a.find("ul li.active:eq(0) > a").css({
                        "border-top-left-radius": "0",
                        "border-top-right-radius": "0"
                    }), t("body").append(a.unwrap().html()), t("body").on("click", (function(t) {
    ...
    }(window.jQuery), $(document).keyup((function(t) {
...
function _add_print_window_default_styles(t) {
    t.document.write("<style>"), t.document.write('.clearfix:after { clear: both;}.clearfix:before, .clearfix:after { display: table; content: " ";}body { font-family: Arial, Helvetica, sans-serif;color: #444; font-size:13px;}.bold { font-weight: bold !important;}'), t.document.write("</style>")
}
...
function appColorPicker(t) {
    void 0 === t && (t = $("body").find("div.colorpicker-input")), t.length && t.colorpicker({
        format: "hex"
    })
}

function appSelectPicker(t) {
    void 0 === t && (t = $("body").find("select.selectpicker")), t.length && t.selectpicker({
        showSubtext: !0
    })
}
...
function alert_float(t, e, n) {
    var i, o;
    i = $("body").find("float-alert").length, i = "alert_float_" + ++i, (o = $("<div></div>", {
        id: i,
        class: "float-alert animated fadeInRight col-xs-10 col-sm-3 alert alert-" + t
    })).append('<button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>'), o.append('<span class="fa-regular fa-bell" data-notify="icon"></span>'), o.append('<span class="alert-title">' + e + "</span>"), $("body").append(o), n = n || 3500, setTimeout((function() {
    ...
    if (0 !== n.length) {
        var i, o, a, r = {
                ...
                fnDrawCallback: function(t) {
                    _table_jump_to_page(this, t), 0 == t.aoData.length || 0 == t.aiDisplay.length ? $(t.nTableWrapper).addClass("app_dt_empty") : $(t.nTableWrapper).removeClass("app_dt_empty"), "function" == typeof s.onDrawCallback && s.onDrawCallback(t, this)
                },
            ...
            l = [10, 25, 50, 100],
            d = [10, 25, 50, 100];
        s.pageLength = parseFloat(s.pageLength), -1 == $.inArray(s.pageLength, l) && (l.push(s.pageLength), d.push(s.pageLength)), l.sort((function(t, e) {
            return t - e
        })), d.sort((function(t, e) {
            return t - e
        })), l.push(-1), d.push(s.dtLengthMenuAllText), s.lengthMenu = [l, d], s.supportsButtons || (s.dom = s.dom.replace("lB", "l")), $.each(n, (function() {
            $(this).addClass("dt-inline"), i = $(this).attr("data-order-col"), o = $(this).attr("data-order-type"), a = $(this).attr("data-s-type"), i && o && (s.order = [
                [i, o]
            ]);
            var t = [];
            if ($(this).find("thead th").each((function(e) {
                    ...
                    void 0 === i || "false" !== i && "0" !== i && !1 !== i || t.push(e), (n.hasClass("no-sort") || n.hasClass("options")) && t.push(e)
                })), t.length > 0 && (s.columnDefs || (s.columnDefs = []), s.columnDefs.push({
                    orderable: !1,
                    targets: t
                })), a) {
                a = JSON.parse(a);
...
function get_datatable_buttons(t) {
    ...
    var o = {
            body: function(t, e, n, i) {
                ...
                a.length && (t = a.attr("data-title")), o.find(".row-options").length > 0 && (o.find(".row-options").remove(), t = o.html().trim()), o.find(".dropdown-toggle").length > 0 && (t = o.find(".dropdown-toggle").text().trim()), o.find(".table-export-exclude").length > 0 && (o.find(".table-export-exclude").remove(), t = o.html().trim());
    ...
    "function" == typeof table_export_button_is_hidden && table_export_button_is_hidden() || a.push({
        ...
        buttons: [{
            ...
            customize: function(e) {
                ...
                }), 10), "persian" != app.user_language.toLowerCase() && "arabic" != app.user_language.toLowerCase() || (e.defaultStyle.font = Object.keys(pdfMake.fonts)[0]), e.styles.tableHeader.alignment = "left", e.defaultStyle.fontSize = 10, e.styles.tableHeader.fontSize = 10, e.styles.tableHeader.margin = [3, 3, 3, 3], e.styles.tableFooter.fontSize = 10, e.styles.tableFooter.margin = [3, 0, 0, 0], e.pageMargins = [2, 20, 2, 20]
            }
        }, {
            extend: "print",
...
function slideToggle(t, e) {
    ...
    })), "function" == typeof appProgressBar && appProgressBar()), "function" == typeof e && e()
}
...
function appDatepicker(t) {
    ...
    0 === o.length && 0 === i.length || ($.each(i, (function() {
        var t = $(this),
            ...
            a = t.attr("data-lazy");
        a && (e.lazyInit = "true" == a), i && (e.maxDate = i), o && (e.minDate = o), t.datetimepicker(e), t.parents(".form-group").find(".calendar-icon").on("click", (function() {
        ...
        var i = t.attr("data-date-end-date"),
            ...
            a = t.attr("data-step"),
            r = t.attr("data-lazy");
        r && (e.lazyInit = "true" == r), a && (e.step = parseInt(a)), i && (e.maxDate = i), o && (e.minDate = o), t.datetimepicker(e), t.parents(".form-group").find(".calendar-icon").on("click", (function() {
            t.focus(), t.trigger("open.xdsoft")
        }))
    })))
}
...
function appTagsInput(t) {
    void 0 === t && (t = $("body").find("input.tagsinput")), t.length && t.tagit({
...
function init_tinymce_inline_editor(t = {}, e) {
    ...
    var i = {
        ...
        browser_spellcheck: !0,
        setup: function(e) {
            t.onSetup && t.onSetup(e), e.addCommand("mceSave", (function() {
                n(!0)
